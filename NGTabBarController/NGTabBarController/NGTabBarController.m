...
#define kNGDefaultAnimationDuration           0.37f
#define kNGScaleFactor                        0.95f
        ...
        if (animated) {
            ...
            [UIView animateWithDuration:kNGDefaultAnimationDuration
                             animations:^{
                                 ...
                                 self.tabBar.frame = CGRectMake(0, self.childViewControllerFrame.size.height, self.tabBar.frame.size.width, self.tabBar.frame.size.height);
