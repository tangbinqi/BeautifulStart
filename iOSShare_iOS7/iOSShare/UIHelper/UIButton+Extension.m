...
+(UIButton*)buttonLeftNavigationItemWithTitle:(NSString*)title;
{
    UIButton *btn=[UIButton buttonWithType:UIButtonTypeCustom];
    btn.frame = CGRectMake(0, 0, 50, 30);
    [btn setBackgroundImage:[UIImage imageNamed:@"btn_top"] forState:UIControlStateNormal];
    [btn setBackgroundImage:[UIImage imageNamed:@"btn_top_press"] forState:UIControlStateHighlighted];
    return btn;
}
