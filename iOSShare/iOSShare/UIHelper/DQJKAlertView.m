...
{
    [DQJKAlertView AlertShow:nil message:message DelegateBlock:^(UIAlertView *alert,int index){
...
{
    [DQJKAlertView AlertShow:title message:message DelegateBlock:^(UIAlertView *alert,int index){
