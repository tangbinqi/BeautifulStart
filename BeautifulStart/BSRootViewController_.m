...
- (void)initSubViewControllers
{
    ...
    homeVC.ng_tabBarItem = [NGTabBarItem itemWithTitle:@"首页"
                                                 image:IMG(@"icon_tab_home")];
    shareVC.ng_tabBarItem = [NGTabBarItem itemWithTitle:@"美妆分享"
                                                  image:IMG(@"icon_tab_share")];
    questionListVC.ng_tabBarItem = [NGTabBarItem itemWithTitle:@"美妆疑问"
                                                         image:IMG(@"icon_tab_question")];
    goosListVC.ng_tabBarItem = [NGTabBarItem itemWithTitle:@"美妆商品"
                                                     image:IMG(@"icon_tab_goods")];
    userCenter.ng_tabBarItem = [NGTabBarItem itemWithTitle:@"个人中心"
                                                     image:IMG(@"icon_tab_usercenter")];
