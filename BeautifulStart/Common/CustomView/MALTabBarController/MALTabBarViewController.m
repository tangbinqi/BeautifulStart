...
- (UIView *)contentView
{
    if (_contentView == nil) {
        ...
        float contentViewHeight = MainScreenBoundsSize.height - tabBarHeight;
        if ([UIDevice currentDevice].systemVersion.floatValue < 7.0) {
            
            contentViewHeight -= 20;
        }
        _contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MainScreenBoundsSize.width,contentViewHeight)];
...
//        [self.tabBar setBackgroundColor:[UIColor colorWithPatternImage:
//                                         [UIImage imageNamed:_tabBarBgImageName]]];
        [self.tabBar setBackgroundColor:[UIColor colorWithHexString:@"FF0080"]];// colorWithRed:255.0f/255.0f green:0.0f/255.0f blue:128.0f/255.0f alpha:1]];
    }
