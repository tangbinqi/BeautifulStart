...
{
    float tabBarY = MALTabBarOrigin.y;
    if ([UIDevice currentDevice].systemVersion.floatValue < 7.0) {
        
        tabBarY -= 20;
    }
    MALTabBar *malTabBar = [[MALTabBar alloc] initWithFrame:CGRectMake(MALTabBarOrigin.x, tabBarY, MALTabBarSize.width, MALTabBarSize.height)];
